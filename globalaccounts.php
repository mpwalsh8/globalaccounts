...
function globalaccounts_install()
{
    ...
    if ($wpga_db_version != WPGA_DB_VERSION)
    {
        ...
        $sql = "CREATE TABLE " . WPGA_USERS_TABLE . " (
            ...
            dressshirtsize ENUM('" . WPGA_SIZE_XS . "', '" . WPGA_SIZE_S . "', '" . WPGA_SIZE_M . "', '" . WPGA_SIZE_L . "', '" . WPGA_SIZE_XL . "', '" . WPGA_SIZE_2XL . "', '" . WPGA_SIZE_3XL . "', '" . WPGA_SIZE_4XL . "') NOT NULL,
            poloshirtsize ENUM('" . WPGA_SIZE_XS . "', '" . WPGA_SIZE_S . "', '" . WPGA_SIZE_M . "', '" . WPGA_SIZE_L . "', '" . WPGA_SIZE_XL . "', '" . WPGA_SIZE_2XL . "', '" . WPGA_SIZE_3XL . "', '" . WPGA_SIZE_4XL . "') NOT NULL,
            teeshirtsize ENUM('" . WPGA_SIZE_XS . "', '" . WPGA_SIZE_S . "', '" . WPGA_SIZE_M . "', '" . WPGA_SIZE_L . "', '" . WPGA_SIZE_XL . "', '" . WPGA_SIZE_2XL . "', '" . WPGA_SIZE_3XL . "', '" . WPGA_SIZE_4XL . "') NOT NULL,
            jacketsize ENUM('" . WPGA_SIZE_XS . "', '" . WPGA_SIZE_S . "', '" . WPGA_SIZE_M . "', '" . WPGA_SIZE_L . "', '" . WPGA_SIZE_XL . "', '" . WPGA_SIZE_2XL . "', '" . WPGA_SIZE_3XL . "', '" . WPGA_SIZE_4XL . "') NOT NULL,
            sweatersize ENUM('" . WPGA_SIZE_XS . "', '" . WPGA_SIZE_S . "', '" . WPGA_SIZE_M . "', '" . WPGA_SIZE_L . "', '" . WPGA_SIZE_XL . "', '" . WPGA_SIZE_2XL . "', '" . WPGA_SIZE_3XL . "', '" . WPGA_SIZE_4XL . "') NOT NULL,
