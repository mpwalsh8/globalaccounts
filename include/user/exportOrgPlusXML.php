 ...
 * @access public
 */
class OrgPlusXMLDoc extends LDAPQueryXMLTree
{
    /**
    ...
    function OrgPlusXMLDoc()
    {
        ...
        if ($ldapQuery->getQueryResultsCount() != 0)
        {
            ...
            parent::LDAPQueryXMLTree($queryResults[0], $this->getLevels()) ;
        }
    }
}

$xmldoc = new OrgPlusXMLDoc();
...
header(sprintf("Content-disposition:  attachment; filename=OrgChart-%s-%s.xml",
    $xmldoc->getOrgKey(), date("Y-m-d"))) ;
